...
- **Next chords (this fork)**: dual-column suggestions from the current chord — **Theory** (left:
  triads/sus/power/sevenths, Fit/Tension, Drama slider, sequence-aware ranking) and **AI** (right:
  pure offline ChordSeqAI GRU rank — no internet, no hybrid blend); play-preview, drag into the
  sequencer or a DAW track; optional host MIDI out for routing to another instrument track.
