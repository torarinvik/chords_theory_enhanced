...
| UI | `Component/NextChordPanel.h/.cpp` |
...
| Tests | `Tests/NextChordGeneratorTests.cpp` tag `[NextChord]` |
...
4. **Rules-based, not corpus-trained** — expert heuristics, not song statistics.
